...
const UI = {
  ...
  inv_c_tier:    { zh: "档次", en: "Tier" },
  inv_c_plays:   { zh: "能玩到", en: "Plays up to" },
  inv_c_specs:   { zh: "规格", en: "Specs" },
  inv_c_note:    { zh: "备注", en: "Notes" },
  inv_tier_entry: { zh: "入门", en: "Entry" },
  inv_tier_mid:   { zh: "中端", en: "Mid" },
